<?php
// Script corregido para extraer TODOS los datos - SQL Syntax Fixed
// Ejecutar: https://camcam.com.ve/evoappws/extract_all_data_fixed.php
...
try {
    ...
    echo "<h2>📊 Extracción COMPLETA de Datos (SQL Corregido)</h2>";
    
    // 1. Extraer TODOS los contactos de TODOS los webhooks
    echo "<h3>📇 Extrayendo TODOS los Contactos (Método Corregido)</h3>";
                ...
                if (!empty($participantJid)) {
                    ...
                    if ($stmt->rowCount() == 0) {
                        ...
                        if (!empty($participantName)) {
                            $this->saveAsContact($event['instance_id'], $participantJid, $participantName, $participantPhone);
                        }
                    }
                }
            }
